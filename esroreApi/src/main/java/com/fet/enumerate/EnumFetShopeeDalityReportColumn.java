...
public enum EnumFetShopeeDalityReportColumn {
	...
	MASTER_ACTIVATION_DATE("GA或NP啟用日期(D天)","MASTER_ACTIVATION_DATE"),
	MASTER_CO_TYPE("GA或NP狀態 ","MASTER_CO_TYPE"),
